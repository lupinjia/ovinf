...
#ifndef OVINF_HUMANOID_WALK_H
#define OVINF_HUMANOID_WALK_H
 ...
 */
class HumanoidWalkPolicy : public BasePolicy<float> {
 ...
 public:
  HumanoidWalkPolicy() = delete;
  ~HumanoidWalkPolicy();

  HumanoidWalkPolicy(const YAML::Node &config);
