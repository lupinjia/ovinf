...
#ifndef OVINF_HUMANOID_WALK_CLOCK_H
#define OVINF_HUMANOID_WALK_CLOCK_H
...
/**
 * @brief self-made walk policy inference
 */
class HumanoidWalkClockPolicy : public BasePolicy<float> {
 ...
 public:
  HumanoidWalkClockPolicy() = delete;
  ~HumanoidWalkClockPolicy();

  HumanoidWalkClockPolicy(const YAML::Node &config);
...
#endif  // !OVINF_HUMANOID_WALK_CLOCK_H
